This is a quiz app that is build using ReactJs, Tailwind CSS and Firebase. Users can create quiz for others and also take quizzes by entering the quiz name.
